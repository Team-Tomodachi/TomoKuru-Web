...
import {createPackageByVenueId, getEventsByVenueId, getPackagesByVenueId, updatePackageByPackageId} from "../../../api";
...
export default function PackageCreation({
    ...
    return (
        <>
            <h1>Create Package for Venue: <span id={"package-title"}>{selectedPackageVenue.location_name}</span></h1>
            {/* Name */}
            <div className="mb-6">
